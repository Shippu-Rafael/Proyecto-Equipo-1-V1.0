...
<head>
    ...
    <script>
        var arregloDT = <?php echo json_encode($usuario->Uconsulta3()); ?>;
...
<body style="background-color: #D0E189  ;>
...
<div class="page-header">
    <h1 style="text-align: center"><p  style="background-color: white">Tabla de Encargados:</p ></h1>
