...
<head>
    ...
    <script>
        var arregloDT = <?php echo json_encode($usuario->Uconsulta4()); ?>;
...
<body style="background-color: #D2D6F3  ;>
...
<div class="page-header">
    <h1 style="text-align: center"><p  style="background-color: white">Tabla de Administración:</p ></h1>
