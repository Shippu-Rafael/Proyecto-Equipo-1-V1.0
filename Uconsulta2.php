...
<head>
    ...
    <script>
        var arregloDT = <?php echo json_encode($usuario->Uconsulta2()); ?>;
...
<body style="background-color: #D5A6D2  ;>
...
<div class="page-header">
    <h1 style="text-align: center"><p  style="background-color: white">Nuestros Choferes:</p ></h1>
