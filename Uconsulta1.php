...
<head>
    ...
    <script>
        var arregloDT = <?php echo json_encode($usuario->Uconsulta1()); ?>;
...
<body style="background-color: #D0A79F  ;>
...
<div class="page-header">
    <h1 style="text-align: center"><p  style="background-color: white">Tabla de personal de Gerencia:</p ></h1>
...
<div id="respuestaFiltro">
    <table id="dtPlantilla" class="display" cellspacing="0" width="100%">
        <thead>
        <tr>
            <th style="color: white">Número del empleado</th>
                    ...
                    <a href="Uconsulta3.php">
                        ...
                        <a href="Uconsulta4.php">
                            ...
                            <a href="Uconsulta.php">
                                <img src="botones/usuario.png" alt="HTML tutorial" style="width:50px;height:50px;">
